...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
			<a class="navbar-brand" href="index.html"><img class="img-fluid" src="images/logo.svg" width="20%"> iego</a>
		  				...
		  				<h1>Diego Monge</h1>
			  				<h2>I'm a 
								  <span
								     class="txt-rotate"
								     data-period="2000"
								     data-rotate='[ "Graphic Designer.", "Video Editor.", "Photographer."]'></span>
								</h2>
							</div>
            </div>
          </div>
					  ...
					  <div id="page-1" class= "page one">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<span class="position">Universidad Don Bosco</span>		    					
	    					</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Bilingual Computer Technician</h2>
		    					<span class="position">Computer Data Systems</span>
		    				</div>
	    				</div>
					  </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>I'm passionate for the audiovisual graphic world, in order to show attractive and creative messages.</p>
